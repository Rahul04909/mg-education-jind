...
<head>
  ...
  <meta name="description"
    content="Explore skill development courses, job exchange opportunities, schemes and skill centres across India. Register or login to access personalized dashboards on MG Skill." />
  ...
  <meta property="og:description"
    content="Discover and enroll in skill development programs, find jobs and explore centres near you." />
  ...
  <style>
    * {
    ...
    body {
      margin: 0;
      font-family: system-ui, -apple-system, Segoe UI, Roboto, Ubuntu, Helvetica, Arial, 'Noto Sans', 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
      color: #0f1419;
      background: #ffffff
    }
