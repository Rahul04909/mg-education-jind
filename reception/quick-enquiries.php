...
<head>
    ...
    <title>Quick Enquiries - Reception Panel</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .enquiry-table tr:hover { background: #fff1f2; }
        ...
        <table class="enquiry-table">
            ...
            <tbody>
                ...
                <tr id="row-<?php echo $row['id']; ?>">
                    ...
                    <td style="font-size:13px; color:var(--text-light); font-style:italic;" id="response-text-<?php echo $row['id']; ?>">
