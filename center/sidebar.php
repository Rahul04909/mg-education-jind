    ...
    <div class="sidebar-content">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu">
                    <li class="submenu-item"><a href="#">All Students</a></li>
                    <li class="submenu-item"><a href="#">New Admission</a></li>
            ...
            <li class="nav-item">
                ...
                <ul class="submenu">
                    <li class="submenu-item"><a href="#">Active Batches</a></li>
                    <li class="submenu-item"><a href="#">Create Batch</a></li>
                    <li class="submenu-item"><a href="#">Timetable</a></li>
                </ul>
            </li>
        ...
        <div class="nav-label" style="margin-top: 24px;">Reports</div>
        <ul class="nav-list">
             <li class="nav-item">
                <a href="#" class="nav-link">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link">
                    <svg class="nav-icon" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                ...
                <li class="nav-item">
                    <a href="manage-fees.php" class="nav-link">
                         <svg class="nav-icon" viewBox="0 0 24 24"><path d="M12 1v22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                        <span class="nav-text">Fee Management</span>
                    </a>
                </li>
            <li class="nav-item">
                <a href="exam-schedule/exam-schedule.php" class="nav-link">
                    <svg class="nav-icon" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
