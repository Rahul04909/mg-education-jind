        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu">
                    ...
                    <li class="submenu-item"><a href="../../admin/internships/manage-syllabus.php">Manage Syllabus</a></li>
                    <li class="submenu-item"><a href="../../admin/internships/manage-study-material.php">Study Material</a></li>
