...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $check = $conn->query("SELECT id FROM gallery_categories WHERE slug = '$slug'");
    if ($check->num_rows > 0) {
        $error_message = "Category with this slug already exists.";
    } else {
        $sql = "INSERT INTO gallery_categories (name, slug, is_active) VALUES ('$name', '$slug', $is_active)";

        if ($conn->query($sql) === TRUE) {
            $success_message = "Gallery Category added successfully!";
        } else {
...
<head>
    ...
    <title>Add Gallery Category - MG Education</title>
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .admin-wrap{max-width:800px;margin:0 auto} /* Smaller width for simple form */
        ...
        <div class="admin-wrap">
            <div class="page-header">
                <div class="breadcrumb">
                    <a href="../index.php">Dashboard</a> › <a href="manage-gallery-category.php">Gallery</a> › Add Category
                </div>
                <h1 class="page-title">Add Gallery Category</h1>
                <p class="page-subtitle">Create a new category for gallery images</p>
            </div>
            ...
            <form method="POST">
                <div class="card">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-input" required placeholder="e.g., Campus Events">
                    </div>
                    <div class="form-group">
